...
public class ctsStartDetection_red_top extends OpenCvPipeline {
    ...
    public ctsStartDetection_red_top(Telemetry telemetry) {
        this.telemetry = telemetry;
        leftTop = new Point(0, 0);
        leftBottom = new Point(0, 0);
        centerTop = new Point(100, 160);         //150 before
        centerBottom = new Point(140, 120);
        rightTop = new Point(215,160 );
        rightBottom = new Point(265, 110);
    }
