package org.firstinspires.ftc.teamcode.cri_oto;

import com.acmerobotics.roadrunner.geometry.Pose2d;
import com.qualcomm.robotcore.hardware.HardwareMap;
public class oto_cri_red{
    ...
    Pose2d back_trav_red = new Pose2d(-22.5+x_offest,-12+y_offest,Math.toRadians(180));
    Pose2d back_trav_dreapta = new Pose2d(-22.5+x_offest,-60+y_offest,Math.toRadians(180));
    Pose2d back_trav_dreapta_schema = new Pose2d(-27+x_offest,-57+y_offest,Math.toRadians(150));
    ...
    Pose2d back_trav_dreapta_mid=new Pose2d(-24+x_offest,-37+y_offest,Math.toRadians(180));
    ...
    Pose2d table_align_red_stanga = new Pose2d(48+x_offest,-31+y_offest,Math.toRadians(180));
    Pose2d table_align_red_mid = new Pose2d(48+x_offest,-35.5+y_offest,Math.toRadians(180));
    Pose2d table_align_red_mid_v2 = new Pose2d(50+x_offest,-37+y_offest,Math.toRadians(180));
    Pose2d table_align_red_dreapta = new Pose2d(48  +x_offest,-43+y_offest,Math.toRadians(180));
    Pose2d red_stack_score_dreapta = new Pose2d(49  +x_offest,-46.5+y_offest,Math.toRadians(198));
    Pose2d red_stack_score_stanga = new Pose2d(49.5  +x_offest,-25.3+y_offest,Math.toRadians(157.4));
    Pose2d red_stack_score_stanga_v2 = new Pose2d(48  +x_offest,-25.3+y_offest,Math.toRadians(157.4));
    Pose2d red_stack_score_stanga_park = new Pose2d(47  +x_offest,-24.3+y_offest,Math.toRadians(157.4));

    Pose2d red_inner_stack_mid= new Pose2d(-57.4  +x_offest,-37.2+y_offest,Math.toRadians(180));
    Pose2d red_inner_stack= new Pose2d(-56.5  +x_offest,-11.5+y_offest,Math.toRadians(180));
    ...
    Pose2d parcare_colt_red = new Pose2d(2+x_offest,2+y_offest,Math.toRadians(0));

    public oto_cri_red(HardwareMap hardwareMap)
    {
