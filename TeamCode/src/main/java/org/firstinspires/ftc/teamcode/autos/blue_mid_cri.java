...
@Autonomous(name="blue_mid_cri")
public class blue_mid_cri extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence unu_d = drive.trajectorySequenceBuilder(oto.start_red_mid)
                ...
                .build();
        TrajectorySequence unu_d1 = drive.trajectorySequenceBuilder(oto.back_trav_red_intermediar)
...
//                .lineToSplineHeading(oto.back_trav_dreapta_schema)
                .UNSTABLE_addTemporalMarkerOffset(0.5, ()-> {
                    ...
                    colectarev2.rotite.setPosition(colectarev2.rotite_score);
...
//
        ...
        TrajectorySequence unu_m = drive.trajectorySequenceBuilder(oto.start_red_mid)
                ...
                .build();
        TrajectorySequence unu_m1 = drive.trajectorySequenceBuilder(oto.back_trav_red_intermediar)
...
//                .lineToSplineHeading(oto.back_trav_dreapta_schema)
        ...
        TrajectorySequence unu_s = drive.trajectorySequenceBuilder(oto.start_red_mid)
                ...
                .build();
        TrajectorySequence unu_s1 = drive.trajectorySequenceBuilder(oto.back_trav_red_intermediar)
