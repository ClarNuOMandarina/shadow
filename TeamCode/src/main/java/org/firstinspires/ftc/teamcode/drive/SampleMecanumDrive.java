...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        rightRear = hardwareMap.get(DcMotorEx.class, "paral");
...
//        }
        ...
        // setLocalizer(new StandardTrackingWheelLocalizer(hardwareMaap, lastTrackingEncPositions, lastTrackingEncVels));
