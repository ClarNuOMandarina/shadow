...
public class ctsStartDetection_red extends OpenCvPipeline {
    ...
    public ctsStartDetection_red(Telemetry telemetry) {
        this.telemetry = telemetry;
        leftTop = new Point(0, 0);
        leftBottom = new Point(0, 0);
        centerTop = new Point(80, 155);         //150 before
        centerBottom = new Point(130, 145);
        rightTop = new Point(215,160 );
        rightBottom = new Point(250, 140);
    }
