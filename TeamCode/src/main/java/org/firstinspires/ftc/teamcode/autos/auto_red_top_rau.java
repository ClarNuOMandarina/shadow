...
@Autonomous(name="red_top_rau")
public class auto_red_top_rau extends LinearOpMode {
...
//                    colectarev2.rotite.setPosition(colectarev2.rotite_score_preload);
                ...
                .lineToSplineHeading(oto.back_trav_red_intermediar_perete)
        ...
        TrajectorySequence unu_s2 = drive.trajectorySequenceBuilder(oto.back_trav_dreapta_schema)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.5, ()-> {
                    ...
                    colectarev2.culisanta_pozitie=1200;
                    colectarev2.culisante();                })
...
//                    colectarev2.rotite.setPosition(colectarev2.rotite_score_preload);
        ...
        CameraDetector_red_top camera = new CameraDetector_red_top(OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, "Webcam 1")));
        CameraDetector_red_top.Result result = CameraDetector_red_top.Result.NONE;
        while (opModeInInit()) {
        ...
        if(caz==1) {
            ...
            while((colectarev2.dreapta.getDistance(DistanceUnit.CM)>1 || colectarev2.stanga.getDistance(DistanceUnit.CM)>1.5)&& cronos.seconds()<2)
            {   }
