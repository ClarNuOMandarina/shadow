...
public class ctsStartDetection_blue extends OpenCvPipeline {
    ...
    public ctsStartDetection_blue(Telemetry telemetry) {
        this.telemetry = telemetry;
        leftTop = new Point(0, 0);
        leftBottom = new Point(0, 0);
        centerTop = new Point(175, 170);
        centerBottom = new Point(130, 150);
        rightTop = new Point(20,165 );
        rightBottom = new Point(    45, 120);
    }
