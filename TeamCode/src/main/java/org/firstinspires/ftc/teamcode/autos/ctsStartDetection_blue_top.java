...
public class ctsStartDetection_blue_top extends OpenCvPipeline {
    ...
    public ctsStartDetection_blue_top(Telemetry telemetry) {
        this.telemetry = telemetry;
        leftTop = new Point(0, 0);
        leftBottom = new Point(0, 0);
        centerTop = new Point(180, 170);
        centerBottom = new Point(210, 150);
        rightTop = new Point(65,200 );
        rightBottom = new Point(100, 180);
    }
