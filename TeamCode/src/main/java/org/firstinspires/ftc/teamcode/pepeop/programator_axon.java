...
@TeleOp(name="progi_axon")
@Config
public class programator_axon extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double i=colectare.transfer_preload ;
        int j=0;
...
//            colectare.extindensre.setTargetPosition(i);
